...
<%@ include file="/header.jsp" %>
  ...
  <div class="form-check">
    ...
    <label for="check_box_2">위 이용약관에 동의합니다.</label>
            ...
            <div id="join-btn">
   <button style="border: 1px solid black; color: black;"  type="button" onclick="onCheckClick()">전체동의</button>
  </div>
  <br/>
  <div id="join-btn">
   <button id="next_btn" type="button"  onclick="onNextClick()">다음</button>
  </div>
        </section>
</div>
