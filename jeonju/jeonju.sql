...
최초로 대사습대회가 베풀어진 뒤 매년 연례행사로 실시되었다.' , 'img/festival_0101.jpg' ,'img/sasup1.png','img/sasup2.png' ,'0' , ' 2024. 05.18(토) ~ 06.03(월)' , 'https://www.jjdss.or.kr/' , ' 전주시, (사)전주대사습놀이보존회, ㈜문화방송, 전주MBC' , ' 전주시, (사)전주대사습놀이보존회, ㈜문화방송, 전주MBC'
)
...
전통 혹은 각 나라 민속음악의 현재의 흐름. 미래의 경향을 들여다보고 비교하는 자리. 그것이 소리축제가 가지고 있는 기본테마라 할 수 있겠다. 전통이 곧 미래이다.' , 'img/168422283508723.jpg' ,'img/sague1.png','img/sague2.png' ,'0' , '2024. 08.14(수) ~ 08.18(일)' , 'https://www.sorifestival.com/2023html/rep_korean/' , '전북특별자치도, 전주세계소리축제조직위' , '전주시 덕진구 소리로 31 한국소리문화의전당 국제회의장 1층 (063-232-8398)'
)
...
2022년 조성된 지역 한복문화 창작소를 중심으로 공연, 교육, 포토존, 체험 프로그램 등 다양한 한복 문화행사를 운영할 예정이다.' , 'img/168367780021169.jpg' ,'img/hanbokfes1.png','img/hanbokfes2.png' ,'0' , '2023. 10. 16.(월) ~ 2023. 10. 22.(일)' , '#' , '전주시 / (재)한국전통문화전당' , '전주시 / (재)한국전통문화전당 (063-281-2931)'
)
